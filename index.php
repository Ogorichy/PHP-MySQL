...
<section id="header">
	<div class="header-contents">
		<h3>Welcome to Chrisgate International</h3>
		<div id="line"></div>
...
<section id="about" class="row">
	<div class="col-lg-6 col-md-6 col-sm-12">
		<div class="myslide">
	<div class="cascade java"> <img src="img/1.jpeg" width="100%"></div>
	<div class="cascade java"> <img src="img/2.jpeg" width="100%"></div>
